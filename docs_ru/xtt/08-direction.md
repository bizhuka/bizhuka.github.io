...
Демо-класс `ZCL_XTT_DEMO_080` расширяет таблицу или дерево по столбцам, а не по строкам. Директива `;direction=column` поддерживается классом `ZCL_XTT_EXCEL_XLSX` для XLSX и XLSM.
