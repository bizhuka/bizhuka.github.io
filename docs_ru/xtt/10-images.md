...
Демо-класс `ZCL_XTT_DEMO_100` заменяет изображения-заполнители в XLSX, DOCX, Word XML и PDF. Заполнитель сохраняет заданные в шаблоне размеры, положение, рамку и другие визуальные свойства.
